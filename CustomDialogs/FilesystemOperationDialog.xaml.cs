...
using CustomDialogs.ViewModels.FileSystemDialog;

namespace CustomDialogs
{
    /// <summary>
    /// Interaction logic for FilesystemOperationDialog.xaml
    /// </summary>
    public partial class FilesystemOperationDialog : Window
    {
